...
export const images = [
  ...
  },
  {
    ...
    interpretationNotes:
      ...
      "Metacarpals" +
      "<ul><li>The epiphysis of the first metacarpal is now more than half as wide as its metaphysis. The trapezoid facet on the proximal end of the second metacarpal is now slightly concave. In Standard I, the metacarpals have a fan-shaped arrangement: the bases of the fourth and fifth metacarpals now partially overlap. The five metacarpal-phalangeal joint spaces have become progressively smaller as the osseous epiphyses of metacarpal and proximal phalanges increased in size.</li></ul/>" +
      "Carpals" +
      "<ul><li>Both a lunate and a hamate facet can now be distinguished on the triquetral. Its free (non-articular) surface remains convex.</li></ul/>",
  },
  {
  ...
  },
  {
    ...
    interpretationNotes:
      ...
      "<li>The capitate surface of the scaphoid now slightly overlaps the adjacent surface of the capitate.</li>" +
      "<li>The white line along the volar margins of the lunate has expanded forming a blunt protuberance pointing at the capitate.</li></ul>" +
      "Radius + Ulna" +
      "<ul><li>The developing styloid process of the radiul epiphysis has become more distinct and the white line adjacent to the cartilage" +
      "plate now extends farther laterally</li></ul>",
  },
  {
